_metaxploit_get_dependency = function(self, dependency)
	...
	if dependency == "metaxploit.so" then
		if not self.metaxploit then
			self.metaxploit = load_metaxploit
...
lib_metaxploit = {"dependencies": {"lib_utils": false, "metaxploit": false, "get_dependency": @_metaxploit_get_dependency }, "establish_connection": @_metaxploit_establish_connection, "get_metalib": @_metaxploit_get_metalib, "execute_exploit": @_metaxploit_execute_exploit, "classID":"MetaxploitLib 1.0.0"}